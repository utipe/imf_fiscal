...
def main():
    ...
    c = Corpus(g8_dir,divide_word_n,devide_sentence_n,devide_topic_n)
    c.output_weight("g8_output_not_divided_w&s&t")
    c.output_scores("g8_output_not_divided_w&s&t")
    c.output_details("g8_output_not_divided_w&s&t")
    c.output_total("g8_output_not_divided_w&s&t")

    divide_word_n = False
    devide_sentence_n = True
    devide_topic_n = False
    c = Corpus(g8_dir,divide_word_n,devide_sentence_n,devide_topic_n)
    c.output_weight("g8_output_not_divided_w&t")
    c.output_scores("g8_output_not_divided_w&t")
    c.output_details("g8_output_not_divided_w&t")
    c.output_total("g8_output_not_divided_w&t")
